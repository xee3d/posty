...
const productIds = Platform.select({
  ios: [
    ...
    "com.posty.tokens.300",
    "com.posty.tokens.1000",
  ],
  android: [
    "starter_monthly",
    "premium_monthly",
...
const subscriptionIds = Platform.select({
  ios: [
    "com.posty.subscription.starter.monthly",
    "com.posty.subscription.premium.monthly",
    "com.posty.subscription.pro.monthly",
  ],
  android: [
