...
class PreparedContentService {
  ...
  private dailyContents: PreparedContent[] = [
    {
      ...
      emoji: '☕',
      title: '월요일 아침 루틴',
      content: '새로운 한 주의 시작! 따뜻한 커피 한 잔과 함께 오늘의 목표를 정리해봐요. 작은 성취들이 모여 큰 변화를 만들어낸답니다. 여러분의 월요일은 어떤가요?',
    ...
    },
    {
      ...
      emoji: '🌤️',
      title: '오늘의 날씨 토크',
      content: '맑은 하늘이 기분까지 맑게 해주는 날이에요! 오늘 같은 날엔 잠깐이라도 밖으로 나가 산책해보는 건 어떨까요? 햇살 가득한 여러분의 하루를 응원합니다!',
    ...
    },
    {
      ...
      emoji: '🍽️',
      title: '점심 메뉴 고민',
      content: '점심 뭐 먹지? 영원한 고민이죠! 오늘은 평소에 잘 안 먹던 메뉴에 도전해보는 건 어떨까요? 새로운 맛의 발견이 일상에 작은 행복을 더해줄 거예요.',
    ...
    },
    {
      ...
      emoji: '🌙',
      title: '하루 마무리',
      content: '오늘 하루도 정말 수고 많으셨어요. 완벽하지 않아도 괜찮아요, 최선을 다한 여러분이 대단한 거예요. 푹 쉬고 내일 또 만나요!',
    ...
    },
    {
      ...
      emoji: '📚',
      title: '독서 타임',
      content: '책 한 권이 주는 위로와 영감. 오늘은 어떤 이야기 속으로 떠나볼까요? 여러분의 인생 책은 무엇인가요? 댓글로 추천해주세요!',
  ...
  private personalizedContents: PreparedContent[] = [
    {
      ...
      emoji: '📸',
      title: '카페 사진 캡션',
      content: '오후의 여유로운 카페타임 ☕ 따뜻한 라떼 한 잔과 함께하는 소중한 나만의 시간. 이런 작은 휴식이 일상을 더 특별하게 만들어주네요.',
    ...
    },
    {
      ...
      emoji: '🏃',
      title: '운동 일정 알림',
      content: '오늘 저녁 운동 가는 날! 💪 꾸준함이 만드는 변화를 믿고, 오늘도 한 걸음 더 나아가요. 운동 후의 상쾌함을 상상하며 화이팅!',
    ...
    },
    {
      ...
      emoji: '🍽️',
      title: '맛집 포스팅',
      content: '드디어 가본 그 맛집! 🤤 웨이팅이 길었지만 기다린 보람이 있네요. 특히 시그니처 메뉴는 정말 강추! 다음엔 누구랑 올까요?',
    ...
    },
    {
      ...
      emoji: '👥',
      title: '친구 만남',
      content: '오랜만에 만나는 소중한 사람들과의 시간 🥰 바쁜 일상 속에서도 이런 만남이 있어 행복해요. 다음 만남이 벌써 기다려지네요!',
    ...
    },
    {
      ...
      emoji: '🌅',
      title: '주말 아침',
      content: '여유로운 주말 아침의 시작 🌞 평일엔 바빠서 놓쳤던 작은 행복들을 천천히 즐겨보는 시간. 오늘은 어떤 하루가 될까요?',
  ...
  private motivationContents: PreparedContent[] = [
    {
      ...
      emoji: '💪',
      title: '도전하는 당신에게',
      content: '실패가 두려워 시작조차 못하고 있나요? 완벽하지 않아도 괜찮아요. 시작이 반이라는 말, 정말 맞는 말이에요. 오늘 작은 한 걸음이 내일의 큰 도약이 될 거예요!',
    ...
    },
    {
      ...
      emoji: '🌟',
      title: '나만의 속도로',
      content: '남들과 비교하지 마세요. 당신만의 속도가 있어요. 꾸준히 한 발짝씩 나아가다 보면 어느새 목표에 도달해 있을 거예요. 자신을 믿어주세요!',
    ...
    },
    {
      ...
      emoji: '🎯',
      title: '목표 달성의 비밀',
      content: '큰 목표를 작은 단계로 나누어보세요. 매일 조금씩 실천하다 보면 어느새 꿈에 가까워져 있을 거예요. 오늘도 한 걸음 더!',
    ...
    },
    {
      ...
      emoji: '🌈',
      title: '어려움 뒤의 무지개',
      content: '비가 온 뒤 무지개가 뜨듯, 힘든 시간 뒤엔 반드시 좋은 날이 옵니다. 지금의 어려움은 더 나은 내일을 위한 준비 과정이에요. 조금만 더 힘내요!',
  ...
  private tipsContents: PreparedContent[] = [
    {
      ...
      content: '인스타그램 게시물의 도달률을 높이고 싶다면? 타겟 팔로워가 가장 활발한 시간대를 노려보세요! 보통 출퇴근 시간(7-9시, 18-20시)과 점심시간(12-13시)이 좋아요.',
    ...
    },
    {
      ...
      emoji: '✍️',
      title: '글쓰기 팁',
      content: '좋은 캡션의 비밀? 진정성 있는 스토리텔링이에요. 완벽한 문장보다 진솔한 감정이 더 와닿아요. 여러분만의 이야기를 들려주세요!',
  ...
  private seasonalContents: PreparedContent[] = [
    {
      ...
      emoji: '🌸',
      title: '봄날의 설렘',
      content: '따스한 봄바람이 불어오네요. 겨우내 움츠렸던 마음도 활짝 피어나는 계절. 오늘은 꽃처럼 환하게 웃어보는 건 어떨까요?',
    ...
    },
    {
      ...
      emoji: '☀️',
      title: '여름의 에너지',
      content: '뜨거운 태양만큼 열정적인 여름! 시원한 바다가 부르는 계절이에요. 올 여름, 어떤 추억을 만들고 싶으신가요?',
    ...
    },
    {
      ...
      emoji: '🍂',
      title: '가을의 감성',
      content: '알록달록 물든 가을 풍경이 마음까지 따뜻하게 해주네요. 독서하기 좋은 계절, 커피 한 잔과 함께 여유를 즐겨보세요.',
    ...
    },
    {
      ...
      emoji: '❄️',
      title: '겨울의 온기',
      content: '추운 날씨지만 마음만은 따뜻하게. 뜨거운 차 한 잔과 포근한 담요, 그리고 소중한 사람들과 함께라면 겨울도 행복해요.',
  ...
  private trendingContents: PreparedContent[] = [
    {
      ...
      emoji: '🎵',
      title: '릴스 챌린지',
      content: '요즘 핫한 챌린지에 도전! 나만의 스타일로 재해석해보세요. 트렌드를 따라가되, 나다움을 잃지 마세요!',
    ...
    },
    {
      ...
      emoji: '🌍',
      title: '친환경 라이프',
      content: '지구를 위한 작은 실천! 텀블러 사용하기, 장바구니 들고 다니기, 분리수거 잘하기. 우리가 할 수 있는 일들이 많아요. 함께 실천해요!',
    ...
    },
    {
      ...
      emoji: '🧘',
      title: '마인드풀니스',
      content: '바쁜 일상 속 잠시 멈춤. 지금 이 순간에 집중해보세요. 깊은 호흡과 함께 마음의 평화를 찾아보는 시간.',
    ...
    },
    {
      ...
      emoji: '💼',
      title: '워라밸 이야기',
      content: '일과 삶의 균형, 쉽지 않죠? 하지만 작은 변화로 시작할 수 있어요. 퇴근 후 30분은 나를 위한 시간으로 만들어보세요!',
  ...
  async getTodayContents(count: number = 3): Promise<PreparedContent[]> {
    ...
    const seasonalContents = otherContents.filter(c => 
      c.category === 'seasonal' && c.title.includes(currentSeason)
    );
    const nonSeasonalContents = otherContents.filter(c => 
      !(c.category === 'seasonal' && c.title.includes(currentSeason))
    );
  ...
  // 카테고리별 콘텐츠 가져오기
  getContentsByCategory(category: PreparedContent['category']): PreparedContent[] {
    switch (category) {
      case 'daily':
  ...
  // 플랫폼별 콘텐츠 가져오기
  getContentsByPlatform(platform: PreparedContent['platform']): PreparedContent[] {
    return this.getAllContents().filter(
      content => content.platform === platform || content.platform === 'general'
    );
  }
