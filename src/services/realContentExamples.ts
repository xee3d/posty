...
export const lowEngagementPatterns = [
  ...
  },
  {
    pattern: "AI스러운 문체",
    example:
      "안녕하세요! 오늘은 정말 멋진 날씨네요. 여러분도 행복한 하루 보내고 계신가요? 저는 카페에서 커피를 마시며 여유로운 시간을 보내고 있답니다.",
    problem: "너무 완벽하고 형식적인 문장",
  },
  {
    pattern: "과한 CTA",
    example:
      "좋아요 꾹! 댓글 필수! 친구 태그! 스토리 공유! 알림 설정! 구독과 좋아요 부탁드려요!",
    problem: "부담스러운 참여 요구",
  },
  {
    pattern: "맥락 없는 해시태그",
    example:
      "커피 마심 #커피 #카페 #일상 #데일리 #맞팔 #선팔 #좋아요 #인스타그램 #팔로우 #소통 #일상스타그램 #좋아요반사",
