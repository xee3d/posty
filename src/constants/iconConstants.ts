...
export const ICON_NAMES = {
  ...
  UMBRELLA: Platform.select({
    ios: "umbrella-outline",
    android: "umbrella-outline",
  }),
  ...
  RESTAURANT: Platform.select({
    ios: "restaurant-outline",
    android: "restaurant-outline",
  }),

  // 기타 UI 아이콘
  ADD_CIRCLE: Platform.select({
  ...
  HOURGLASS: Platform.select({
    ios: "hourglass-outline",
    android: "hourglass-outline",
  }),
  PULSE: Platform.select({ ios: "pulse-outline", android: "pulse-outline" }),
  COLOR_WAND: Platform.select({
    ios: "color-wand-outline",
    android: "color-wand-outline",
  }),

  // 트렌드/통계 관련
  TRENDING_UP: Platform.select({
    ios: "trending-up-outline",
    android: "trending-up-outline",
  }),
  TRENDING_DOWN: Platform.select({
    ios: "trending-down-outline",
    android: "trending-down-outline",
  }),

  // 내비게이션
  CHEVRON_UP: Platform.select({ ios: "chevron-up", android: "chevron-up" }),
  CHEVRON_DOWN: Platform.select({
    ios: "chevron-down",
    android: "chevron-down",
  }),
  ARROW_FORWARD: Platform.select({
    ios: "arrow-forward",
...
export type MaterialIconName =
  (typeof MATERIAL_ICON_NAMES)[keyof typeof MATERIAL_ICON_NAMES];
