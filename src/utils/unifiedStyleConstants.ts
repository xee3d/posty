...
export const UNIFIED_STYLES: StyleDefinition[] = [
...

  {
    ...
    characteristics: {
      avgLength: "150-250자",
      emojis: ["📝", "📄", "✍️", "💭", "📚"],
      keywords: ["하였다", "되었다", "있었다", "것이다", "바이다"],
      structure: ["객관적 서술", "정중한 표현", "완전한 문장"],
      examples: [
        "오늘 방문한 카페에서 인상 깊은 경험을 하였다. 오랜 시간 그곳에 머물며 책을 읽는 동안 마음이 평온해졌다.",
        "주말을 맞아 가족들과 함께한 시간이 매우 의미있었다. 일상의 소중함을 다시 한번 깨닫게 되는 계기가 되었다.",
      ],
    },
    tips: [
      "정중하고 격식있는 어조 사용",
...

  {
    ...
    characteristics: {
      avgLength: "100-150자",
      emojis: ["🌙", "🌊", "🕊️", "🌸", "⭐", "🍃", "💎"],
      keywords: ["고요", "새벽", "별빛", "바람", "꽃잎", "물결", "여운"],
      structure: ["시적 운율", "은유적 표현", "자연 이미지", "내면의 소리"],
      examples: [
        "새벽안개 사이로 스며드는 햇살처럼,\n오늘도 희망은 조용히 마음에 내려앉는다 🌅",
        "바람에 흩날리는 꽃잎들이 말한다.\n아름다운 것은 영원하지 않기에 더욱 소중하다고 🌸",
        "고요한 밤하늘의 별 하나하나가\n우리 안에 잠든 꿈들을 깨우고 있다 ⭐",
        "물방울이 바위를 뚫듯이\n작은 친절이 차가운 마음을 녹인다 💧",
      ],
    },
