...
export const PushNotificationSettings: React.FC<PushNotificationSettingsProps> = ({ style }) => {
  const { colors } = useAppTheme();
  const { state, requestPermission, sendTestNotification, subscribeToTopic, unsubscribeFromTopic } = usePushNotifications();
   ...
   * 알림 타입별 구독 관리
   */
  const handleNotificationTypeToggle = async (type: keyof typeof notificationTypes) => {
    ...
    try {
      ...
      console.error(`Failed to ${newValue ? 'subscribe' : 'unsubscribe'} ${topicName}:`, error);
    }
  };
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingItem}>
          ...
          <Switch
            ...
            thumbColor={state.hasPermission ? colors.background : colors.text.tertiary}
          />
        </View>
        ...
        {state.hasPermission && (
          <>
            ...
            <View style={styles.settingItem}>
              <View style={styles.settingLeft}>
                <Icon name="trophy-outline" size={18} color={colors.text.secondary} />
              ...
              <Switch
                ...
                trackColor={{ false: colors.border, true: colors.primary }}
                thumbColor={notificationTypes.missions ? colors.background : colors.text.tertiary}
              />
            </View>

            <View style={styles.settingItem}>
              <View style={styles.settingLeft}>
                <Icon name="trending-up-outline" size={18} color={colors.text.secondary} />
              ...
              <Switch
                ...
                trackColor={{ false: colors.border, true: colors.primary }}
                thumbColor={notificationTypes.trends ? colors.background : colors.text.tertiary}
              />
            </View>

            <View style={styles.settingItem}>
              <View style={styles.settingLeft}>
                <Icon name="flash-outline" size={18} color={colors.text.secondary} />
              ...
              <Switch
                ...
                trackColor={{ false: colors.border, true: colors.primary }}
                thumbColor={notificationTypes.tokens ? colors.background : colors.text.tertiary}
              />
            </View>

            <View style={styles.settingItem}>
              <View style={styles.settingLeft}>
                <Icon name="medal-outline" size={18} color={colors.text.secondary} />
                <Text style={styles.settingLabel}>업적 알림</Text>
              </View>
              <Switch
                value={notificationTypes.achievements}
                onValueChange={() => handleNotificationTypeToggle('achievements')}
                trackColor={{ false: colors.border, true: colors.primary }}
                thumbColor={notificationTypes.achievements ? colors.background : colors.text.tertiary}
              />
            </View>

            <View style={styles.settingItem}>
              <View style={styles.settingLeft}>
                <Icon name="bulb-outline" size={18} color={colors.text.secondary} />
              ...
              <Switch
                ...
                trackColor={{ false: colors.border, true: colors.primary }}
                thumbColor={notificationTypes.tips ? colors.background : colors.text.tertiary}
              />
            </View>
