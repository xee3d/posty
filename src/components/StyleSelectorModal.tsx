...
const StyleSelectorModal: React.FC<StyleSelectorModalProps> = ({
  ...
  const [selectedCategory, setSelectedCategory] = useState<'all' | 'fun' | 'serious' | 'special'>('all');
  ...
  const getFilteredStyles = () => {
    if (selectedCategory === 'all') return UNIFIED_STYLES;
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          {/* 스타일 그리드 */}
          <ScrollView style={styles.styleGrid} showsVerticalScrollIndicator={false}>
