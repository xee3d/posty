...
const ModernOnboardingScreen: React.FC<ModernOnboardingScreenProps> = ({
  onComplete,
}) => {
    ...
    <View style={styles.agreementContainer}>
      ...
      >
        <View style={styles.agreementRow}>
          ...
          <Text
            style={[styles.allAgreementText, { color: colors.text.primary }]}
          >
            모든 약관에 동의합니다
          </Text>
        </View>
      ...
      <View style={styles.individualAgreements}>
        {[
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              handleIndividualAgreement(item.key as keyof Agreements)
            }
            activeOpacity={0.7}
          >
            <View style={styles.agreementRow}>
              <View
                style={[
                  ...
                  agreements[item.key as keyof Agreements] &&
                    styles.modernCheckboxChecked,
                  {
                    borderColor: agreements[item.key as keyof Agreements]
                      ? colors.primary
                      : colors.border,
                  },
                ]}
        ...
        >
          <View
            style={[
              ...
              { backgroundColor: permission.color + "15" },
            ]}
          >
            <SafeIcon
