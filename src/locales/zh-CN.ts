const zhCN = {
  ...
  subscription: {
    ...
    features: {
      ...
      tones6: "6种语调风格",
      allLengths: "支持所有长度",
      fastImageAnalysis: "快速图像分析",
      gpt4Model: "GPT-4模型",
      unlimitedTokens: "无限代币",
      allTones: "所有语调风格",
      instantImageAnalysis: "即时图像分析",
      gpt4TurboModel: "GPT-4 Turbo模型",
      apiAccess: "API 访问",
    ...
    benefits: {
      ...
      moreTokens: {
        title: "更多代币",
        description: "STARTER注册时200个代币，PRO注册时500个代币，MAX注册时1500个代币"
      },
      advancedAI: {
        title: "高级AI模型",
    ...
    membershipNotices: {
      ...
      starter: "STARTER会员注册时获得200个代币",
      premium: "PRO会员注册时获得500个代币",
      pro: "MAX会员获得无限代币"
    },
  ...
  aiWrite: {
    ...
    premium: {
      ...
      toneMessage: "{tone}风格仅在专业版中可用。",
      unlockedTitle: "风格解锁！",
      unlockedMessage: "{tone}风格现在可以一次性使用。",
    },
