const ja = {
  ...
  subscription: {
    ...
    features: {
      ...
      hasAds: "広告あり",
      signup300: "サインアップ時300トークン",
      daily10: "毎日10トークン追加",
      tones4: "4つのトーンスタイル",
      longLength: "長い記事対応",
      noAds: "広告なし",
      myStyleAnalysis: "マイスタイル分析",
      signup500: "サインアップ時500トークン",
      daily20: "毎日20トークン追加",
      tones6: "6つのトーンスタイル",
      allLengths: "すべての長さ対応",
      fastImageAnalysis: "高速画像分析",
      gpt4Model: "GPT-4モデル",
      unlimitedTokens: "無制限トークン",
      allTones: "すべてのトーンスタイル",
      instantImageAnalysis: "瞬時画像分析",
      gpt4TurboModel: "GPT-4 Turboモデル",
      apiAccess: "API アクセス",
  ...
  aiWrite: {
    ...
    alerts: {
      ...
      watchAdToWrite: "広告を視聴すると1トークンを獲得してすぐに書くことができます！",
      watchAd: "広告を見て書く",
      success: "完成いたしました！🎉",
